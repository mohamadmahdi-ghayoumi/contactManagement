...
// function InputContact({title , setValue}: {title : string , setValue:React.Dispatch<React.SetStateAction<string>>}) {
...
//     outline-none border-neutral-200 border-1 border py-1 pr-2 rounded-md"
//     />
// { inputValue === ""  &&  <p className='text-red-500 '>لطفا
//     {title} را وارد کنید</p>
// }  </div>  )
// }
